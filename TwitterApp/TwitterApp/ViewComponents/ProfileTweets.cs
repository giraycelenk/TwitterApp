...
{
    public class ProfileTweets:ViewComponent
    {
        private ITweetRepository _tweetRepository;
        private IUserRepository _userRepository;
        
        public ProfileTweets(ITweetRepository tweetRepository,IUserRepository userRepository)
        {
            _tweetRepository = tweetRepository;
            _userRepository = userRepository;
        }
        public async Task<IViewComponentResult> InvokeAsync(bool IsProfilePage = true,string username="")
        {
